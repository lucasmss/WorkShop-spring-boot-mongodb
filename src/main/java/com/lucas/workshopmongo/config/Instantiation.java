...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("30/03/2019"), "Bom Dia", "Paris, tamo aqui!!", new AuthorDTO(maria));
		
		CommentDTO c1 = new CommentDTO("Boa Viagem mano!", sdf.parse("21/03/2019"), new AuthorDTO(alex));
		CommentDTO c2 = new CommentDTO("Aproveite", sdf.parse("22/09/2019"), new AuthorDTO(bob));
		CommentDTO c3 = new CommentDTO("Tenha um ótimo dia", sdf.parse("23/06/2019"), new AuthorDTO(alex));
